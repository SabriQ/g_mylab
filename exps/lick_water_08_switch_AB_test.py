...
import numpy as np
class LickWater(Exp):
    def __init__(self,port,data_dir=r"E:\linear_track",mode="switch_AB_test",video_record=True):
        ...
        self.mode = mode
        modes = ["adaptation_40cm","adaptation_60cm","adaptation_80cm","adaptation_80cm_CCC","local-global","elements-omission","train","test","all_blank","switch_AB_test"]
