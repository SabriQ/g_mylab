...
import numpy as np
class LickWater(Exp):
    def __init__(self,port,data_dir=r"E:\linear_track",mode="test_3ctx",video_record=True):
        ...
        self.mode = mode
        modes = ["adaptation_40cm","adaptation_100cm","train","test","local-global","test_switchlocation","test_3ctx","train_3ctx"]
